...
(
	...
	`ConditionScaleQuantity`           varchar(16) DEFAULT NULL,
	...
	`ConditionQuantity`                varchar(5) DEFAULT NULL,
	`ConditionQuantityUnit`            varchar(3) DEFAULT NULL,
	`ConditionToBaseQtyNmrtr`          varchar(5) DEFAULT NULL,
	`ConditionToBaseQtyDnmntr`         varchar(5) DEFAULT NULL,
	`BaseUnit`                         varchar(3) DEFAULT NULL,
	`ConditionLowerLimit`              varchar(13) DEFAULT NULL,
	`ConditionUpperLimit`              varchar(13) DEFAULT NULL,
	...
	`MinimumConditionBasisValue`       varchar(16) DEFAULT NULL,
	`MaximumConditionBasisValue`       varchar(16) DEFAULT NULL,
